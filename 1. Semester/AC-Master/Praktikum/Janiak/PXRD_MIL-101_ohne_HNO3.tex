...
\begin{document}
	...
	\begin{tikzpicture}
		\begin{axis}[
			...
			% x dir=reverse,
			% y dir=reverse
			title=Pulverdiffraktogram von MIL-101 ohne \ch{HNO3}
			]
			\addplot [black] table [x index=0,y index=1,col sep=semicolon]{C:/Users/assma/OneDrive/Desktop/M._Sc._Chemie/1. Semester/AC-Master/Praktikum/Janiak/MIL101_ohne_Modulator_Gr_15_16_norm.txt};
		\end{axis}
	\end{tikzpicture}
