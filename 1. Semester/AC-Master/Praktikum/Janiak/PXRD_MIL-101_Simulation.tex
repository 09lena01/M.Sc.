...
\begin{document}
	...
	\begin{tikzpicture}
		\begin{axis}[
			...
			% x dir=reverse,
			% y dir=reverse
			title=Pulverdiffraktogram von MIL-101 -- Simulation
			]
			\addplot [black] table [x index=0,y index=1,col sep=semicolon]{C:/Users/assma/OneDrive/Desktop/M._Sc._Chemie/1. Semester/AC-Master/Praktikum/Janiak/MIL-101Cr_Simulation_norm.txt};
		\end{axis}
	\end{tikzpicture}
