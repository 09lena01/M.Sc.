...
\begin{document}
	...
	\begin{tikzpicture}
		\begin{axis}[
			...
			%\addplot [cyan] table [x index=0,y index=1,col sep=semicolon]{C:/Users/assma/OneDrive/Desktop/M._Sc._Chemie/1. Semester/AC-Master/Praktikum/Janiak/MIL101_ohne_Modulator_Gr_15_16_norm.txt};
			\legend{Simulation, mit \ch{HNO3}, ohne \ch{HNO3}}
		\end{axis}
	\end{tikzpicture}
